/**
 * Versioned weight tables for residual risk scoring.
 * Transparent and tunable — not a black box.
 *
 * Directional until a CPA calibrates them. Never score people;
 * score control design and residual risk.
 */
export { SCORING_VERSION } from "../version";

/** Inherent risk factors (0–1 contribution before normalization). Directional. */
...
/** Control effectiveness factors (higher = stronger control). Directional. */
...
/** Staff composition modifiers applied after residual. Directional. */
