/**
 * Shared domain types for the controls engine.
 * Scores attached to these shapes are directional until a CPA calibrates them.
 * Never score people — score control design and residual risk.
 */
