...
(function () {
  ...
  function build(seedNum) {
    ...
    const appointments = [
      ...
      { id: 'a-1046', patientId: 'p-305', locationId: 'loc-1', op: 2, time: '08:00', type: 'exam', providerId: 'u-dr-1', status: 'note_filed', eligibility: 'green', encounterId: 'enc-9005', formsDone: true, balanceCents: 18000 },
