...
| Ledger | `ledger.explain`, `ledger.asof`, `ledger.showpatient`, `ledger.sendbiller`, `ledger.statement.send`, `ledger.statement.preview`, `ledger.statement.preview.close`, `ledger.row.<entryId>` |
